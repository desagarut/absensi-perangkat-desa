<div class="card-body">
    ...
    <div id="dataPerangkat" class="card-body table-responsive pb-5">
        <?php if (!empty($data)) : ?>
                ...
                <tbody>
                    ...
                    <?php foreach ($data as $value) : ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if (!$lewat) : ?>
                                    <button data-toggle="modal" data-target="#ubahModal" onclick="getDataKehadiran(<?= $value['id_presensi'] ?? '-1'; ?>, <?= $value['id_perangkat']; ?>)" class="btn btn-info p-2" id="<?= $value['nipd']; ?>">
