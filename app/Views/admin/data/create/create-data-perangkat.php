         ...
         <div class="col-lg-12 col-md-12">
            <div class="card">
               <div class="card-header card-header-primary">
                  <h4 class="card-title"><b>Form Tambah Perangkat</b></h4>
                  <!-- <p class="card-category">Angkatan 2022/2023</p> -->
               </div>
               <div class="card-body mx-5 my-3">

                  <form action="<?= base_url('admin/perangkat/create'); ?>" method="post">
                     <?= csrf_field() ?>
                     ...
                     <div class="form-group mt-4">
                        ...
                        <input type="text" id="nipd" class="form-control <?= $validation->getError('nipd') ? 'is-invalid' : ''; ?>" name="nipd" placeholder="1234" value="<?= old('nipd') ?? $oldInput['nipd']  ?? '' ?>">
                     ...
                     <div class="row">
                        ...
                        <div class="col-md-6">
                           <label for="jk">Jenipd Kelamin</label>
                           <?php
                           if (old('jk')) {
