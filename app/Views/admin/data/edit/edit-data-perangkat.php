         ...
         <div class="col-lg-12 col-md-12">
            <div class="card">
               <div class="card-header card-header-primary">
                  <h4 class="card-title"><b>Form Edit Perangkat</b></h4>
                  <!-- <p class="card-category">Angkatan 2022/2023</p> -->
               </div>
               <div class="card-body mx-5 my-3">

                  <form action="<?= base_url('admin/perangkat/edit'); ?>" method="post">
                     <?= csrf_field() ?>
                     ...
                     <input type="hidden" name="id" value="<?= $data['id_perangkat']; ?>">

                     <div class="form-group mt-4">
                        <label for="nipd">NIPD/NIK/NIP</label>
                        <input type="text" id="nipd" class="form-control <?= $validation->getError('nipd') ? 'is-invalid' : ''; ?>" name="nipd" placeholder="1234" value="<?= old('nipd') ?? $oldInput['nipd'] ?? $data['nipd'] ?>">
                        <div class="invalid-feedback">
                           <?= $validation->getError('nipd'); ?>
                        </div>
                     </div>

                     <div class="form-group mt-4">
                        <label for="nama">Nama Lengkap</label>
                        <input type="text" id="nama" class="form-control <?= $validation->getError('nama') ? 'is-invalid' : ''; ?>" name="nama" placeholder="Your Name" value="<?= old('nama') ?? $oldInput['nama'] ?? $data['nama_perangkat'] ?>">
                        <div class="invalid-feedback">
