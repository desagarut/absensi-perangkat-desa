                  ...
                  <div class="row">
                     <div class="col-md-6">
                        <div class="card h-100">
                           <form action="<?= base_url('admin/laporan/perangkat'); ?>" method="post" class="card-body d-flex flex-column">
                              <h4 class="text-primary"><b>Laporan Absen Perangkat</b></h4>
                              <div class="row align-items-center">
                                 <div class="col-auto">
                                    <p class="d-inline"><b>Bulan :</b></p>
                                 </div>
                                 <div class="col-5">
                                    <input type="month" name="tanggalPerangkat" id="tanggalPerangkat" class="form-control" value="<?= date('Y-m'); ?>">
                                 </div>
                              </div>
                              <select name="kelas" class="custom-select mt-3">
                                 ...
                                 <?php foreach ($kelas as $value) : ?>
                                    ...
                                    $jumlahPerangkat = count($perangkatPerKelas[$idKelas - 1]);
                                    ?>
                                    <option value="<?= $idKelas; ?>">
                                       <?= "$kelas - {$jumlahPerangkat} perangkat"; ?>
                                    </option>
                                 <?php endforeach; ?>
                              </select>
