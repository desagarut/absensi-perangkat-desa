...
<table>
   <tr>
      ...
      <td width="100%">
         <h2 align="center">DAFTAR HADIR PERANGKAT DESA/KELURAHAN</h2>
         <h4 align="center">KECAMATAN TAROGONG KALER</h4>
         <h4 align="center">TAHUN 2022/2023</h4>
      </td>
      <td>
...
<table align="center" border="1">
   ...
   <?php foreach ($listPerangkat as $perangkat) : ?>
      <tr>
...
<table>
   <tr>
      ...
      <td>: <?= count($listPerangkat); ?></td>
   </tr>
   <tr>
      <td>Laki-laki</td>
      <td>: <?= $jumlahPerangkat['laki']; ?></td>
   </tr>
   <tr>
      <td>Perempuan</td>
      <td>: <?= $jumlahPerangkat['perempuan']; ?></td>
   </tr>
</table>
<?php
